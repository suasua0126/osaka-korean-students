  ...
  return (
    <div className="max-w-xl mx-auto py-16 px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
        <a href="https://www.instagram.com/omu_kr_info?igsh=NW0xaXFsbGxodGg0" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center p-6 border rounded-xl shadow hover:bg-blue-50 transition">
